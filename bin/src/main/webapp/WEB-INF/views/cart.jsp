...
<div class="container">
    <div class="row col-10 offset-1">
        ...
        <main class="row col-12 mb-5">
            <form class="container" action="/order/add" method="post">
                <div class="form-group">
                    <label >Địa chỉ</label>
                    <textarea class="form-control" name="add" rows="3"></textarea>
                </div>
                <div class="col-md-3 mt-3 mb-3 text-end" style="margin-left: 250px">
            ...
            <table class="table">
                ...
                <c:forEach items="${cart}" var="entry">
                    <tr>
                        ...
                        <td>${entry.value}</td>
                        <td>
                            <fmt:formatNumber pattern="#,###" value="${entry.key.price * entry.value}">
